                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav pull-right">
                                <!-- <li><a href="index.php" class="waves-effect waves-light"><i class="glyphicon glyphicon-home"></i> Home</a></li> -->
                                <li class="dropdown">
...
?>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                   ...
                                   $sql="SELECT t1.*, t2.* FROM service1 t1 JOIN fservice t2 ON t1.sid = $sid WHERE t1.serid = t2.serid";
                                    ...
                                    while($row = mysqli_fetch_array($result)) {    
                                            ?>                            
                                        <div class="item"><a href="servicee.php?id=<?php echo  $row['serid'] ?>">
        ...
        <div class="row">
                            <div class="m-b-15">
                                    ...
                                    <a href="servicee.php?id=<?php echo  $row['serid'] ?>" class="image-popup" title="<?php echo  $row['sername'] ?>" data-toggle="tooltip" >
                                        ...
                                        <div class="detail">
                                            <h4 class="m-t-0"><a href="servicee.php?id=<?php echo  $row['serid'] ?>" class="text-dark" data-toggle="tooltip" title="<?php echo  $row['sername'] ?>"><?php echo  $row['sername'] ?></a> </h4>
                                            <div class="rating">
                                                <ul class="list-inline">
                                                    <a href="show-rating-guest.php?id=<?php echo $row['serid'] ?>" data-toggle="tooltip" title="Ratings">
  <?php
  require_once('dbconfig.php');
  $serid = $row['serid'];
