<div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="manager-page.php" class="logo "><img src="assets/logo.png" style="width: 50px; height: 50px;"><span><img src="assets/logotsis.png" style="width: 150px; height: 50px;"></span></a>
                        <!-- Image Logo here -->
                                      ...
                                      <?php 
                                       ...
                                       ?>
                                            ...
                                            <ul class="dropdown-menu">
                                                    ...
                                                    <li class="divider"></li>
                                                    <li><a href="manager-info.php?id=<?php echo $row['mid'] ?>"><i class="md md-settings m-r-10"></i>Account Settings</a></li>
                                                <li><a href="manager-logout.php"><i class="ti-power-off m-r-10 text-danger"></i> Logout</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown top-menu-item-xs">
                                       <a href="#" class="dropdown-toggle notif" data-toggle="dropdown"><span class="label label-pill label-danger count" style="border-radius:10px;"></span> <span class="glyphicon glyphicon-bell"></span></a>
                                   <ul class="dropdown-menu notif-menu"style="height: auto; max-height: 500px;
                                    overflow-x: hidden;">     
                                    </ul>
