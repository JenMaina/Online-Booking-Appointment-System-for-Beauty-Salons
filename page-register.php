...
function newUser()
{
		...
		$password=$_POST['pwd'];
		$prepeat=$_POST['pwdr'];
		$sql = "INSERT INTO customer (name, gender, address, dob, contact, email, username, password) VALUES ('$name','$gender', '$address', '$dob','$contact','$email','$username','$password') ";
		...
		<div class="wrapper-page">
			<div class=" card-box">
				...
				<div class="panel-heading">
                    <br>
					<h3 class="text-center"> Sign Up as <strong class="text-custom">Customer</strong> </h3>
				</div>

				<div class="panel-body">
					<!-- <form class="form-horizontal m-t-20" action="index.php"> -->
                            <form class="form-horizontal m-t-20" action="page-register.php" method="post">
						...
						<div class="form-group">
							<div class="col-xs-12">
								<div class="checkbox checkbox-primary">
									...
									<label for="checkbox-signup">I accept <a href="" data-toggle="modal" data-target="#con-close-modal">Terms and Conditions</a></label>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<p>
						Already have account?<a href="customer-login.php" class="text-primary m-l-5"><b>Sign In</b></a>
					</p>
				</div>
			</div>
